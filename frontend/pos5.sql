...
CREATE TABLE `grn` (
  ...
  `total` decimal(18,2) NOT NULL,
  `vat_percentage` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `discount` varchar(4) DEFAULT NULL,
  `vat_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `disc_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `grn_return_note` (
  ...
  `vat_percentage` varchar(4) DEFAULT NULL,
  `final` decimal(18,2) NOT NULL DEFAULT '0.00',
  `completed` decimal(18,2) NOT NULL DEFAULT '0.00',
  `remarks` text NOT NULL,
  `discounted_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `vat_amount` decimal(18,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `main_transes` (
  ...
  `amount` decimal(18,2) NOT NULL,
  `completed` decimal(18,2) NOT NULL,
  `remarks` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE `main_trans_transactions` (
  `date` date NOT NULL,
  `main_trans_id` int NOT NULL,
...
CREATE TABLE `petty_book` (
  `id` int NOT NULL,
  `transaction_type` varchar(3) NOT NULL DEFAULT 'OUT',
  `account` int NOT NULL,
  `type` int DEFAULT NULL,
  `reason` varchar(200) NOT NULL,
  `amount` decimal(18,2) NOT NULL,
  `remarks` varchar(200) NOT NULL,
  `settle` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE `petty_type` (
  `id` int NOT NULL,
...
CREATE TABLE `purchase_order` (
  ...
  `discount` varchar(20) DEFAULT NULL,
  `vat_percentage` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `discount_am` decimal(18,2) NOT NULL DEFAULT '0.00',
  `vat_am` decimal(18,2) NOT NULL DEFAULT '0.00',
  `final` decimal(18,2) NOT NULL,
  `remarks` text,
  `uid` int NOT NULL,
...
ALTER TABLE `main_transes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `account` (`account`),
  ADD KEY `type` (`type`);

ALTER TABLE `main_trans_transactions`
  ADD KEY `main_trans_id` (`main_trans_id`),
  ADD KEY `transaction_id` (`transaction_id`);

ALTER TABLE `main_types`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `petty_account`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `petty_book`
  ADD PRIMARY KEY (`id`),
  ADD KEY `account` (`account`),
  ADD KEY `type` (`type`);

ALTER TABLE `petty_type`
  ADD PRIMARY KEY (`id`),
  ADD KEY `account` (`account`);
...
ALTER TABLE `main_transes`
  ADD CONSTRAINT `main_transes_ibfk_1` FOREIGN KEY (`account`) REFERENCES `main_account` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `main_transes_ibfk_2` FOREIGN KEY (`type`) REFERENCES `main_types` (`id`) ON DELETE RESTRICT;

ALTER TABLE `main_trans_transactions`
  ADD CONSTRAINT `main_trans_transactions_ibfk_1` FOREIGN KEY (`main_trans_id`) REFERENCES `main_transes` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `main_trans_transactions_ibfk_2` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE RESTRICT;

ALTER TABLE `main_types`
  ADD CONSTRAINT `main_types_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `main_account` (`id`) ON DELETE RESTRICT;

ALTER TABLE `petty_book`
  ADD CONSTRAINT `petty_book_ibfk_1` FOREIGN KEY (`account`) REFERENCES `petty_account` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `petty_book_ibfk_2` FOREIGN KEY (`type`) REFERENCES `petty_type` (`id`) ON DELETE RESTRICT;

ALTER TABLE `petty_type`
  ADD CONSTRAINT `petty_type_ibfk_1` FOREIGN KEY (`account`) REFERENCES `petty_account` (`id`) ON DELETE RESTRICT;
